...
from modbus_serviceCall import control_client
...
class Ui_MainWindow(object):
    ...
    def Charge(self):
        self.control_client("charge", 1)

    def Emer(self):
        self.control_client("stop", 1)
    ...
    def setFanSpeed(self):
        speed = self.SpeedPreset_comboBox.currentText()
        if speed == "OFF":
            self.control_client("fan", 0)
        elif speed == "LOW":
            self.control_client("fan", 64)
        elif speed == "MID":
            self.control_client("fan", 127)
        elif speed == "HIGH":
            self.control_client("fan", 255)
    ...
    def control_client(self, mode, val):
